            ...
            <div>
                ...
                <Table entries={entries} />
                    ...
                    <div className="text-center py-28 space-y-5">
                        ...
                        <button onClick={() => navigate("/#")} className="rounded-md bg-amber-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-amber-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500">Start Journaling</button>
                    </div>
                )}
            </div>
        </div>
