...
export default function Header() {
    ...
    if (loggedIn && isProfilePage) {
        buttons = (
            <>
                <a href="/" className="bg-amber-500 text-white px-6 py-1 rounded-md shadow-sm hover:bg-amber-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500">Home</a>
                <button onClick={() => logout()} className="ml-0.5 sm:ml-4 bg-amber-500 text-white px-6 py-1 rounded-md shadow-sm hover:bg-amber-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500">Logout</button>
            </>
        );
        // else if the user is logged in but not on the 'profile' page then...
    } else if (loggedIn) {
        buttons = (
        ...
        // else if the user is not logged in then...
    } else {
        buttons = (
